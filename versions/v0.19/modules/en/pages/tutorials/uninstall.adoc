...
:description: Uninstall SUSE® Rancher Prime Cluster API with a Helm command; this may take a few minutes and requires re-enabling the embedded-cluster-api feature
:revdate: 2025-05-06
