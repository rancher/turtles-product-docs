...
:description: Uninstall SUSE® Rancher Prime Cluster API by running a Helm command, wait until it completes, then re-enable the embedded-cluster-api feature by creating
:revdate: 2025-05-30
