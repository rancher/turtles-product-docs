= Manual Installation
:description: Install SUSE® Rancher Prime Cluster API manually using the Helm CLI by adding the required repository, deploying the Helm chart, and managing dependencies
:revdate: 2025-09-15
