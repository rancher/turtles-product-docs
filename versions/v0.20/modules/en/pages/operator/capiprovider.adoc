...
:description: Create a CAPIProvider resource that has provider name, type, credentials, configuration, and features to manage Cluster API Operator manifests declaratively
:revdate: 2026-06-26
