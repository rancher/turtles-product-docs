...
Rancher Turtles meets https://slsa.dev/spec/v1.0/levels[SLSA Level 3] requirements.
...
* The Rancher Turtles project uses the official https://github.com/slsa-framework/slsa-github-generator[SLSA GitHub Generator] project for provenance generation and distribution.
...
* The provenance of the Rancher Turtles container images can be verified using the official https://github.com/slsa-framework/slsa-verifier[SLSA verifier tool].
...
* The https://github.com/slsa-framework/slsa-github-generator[SLSA GitHub Generator] runs on separate virtual machines than the build and release process, so that the Rancher Turtles build scripts don't have access to the signing secrets.
