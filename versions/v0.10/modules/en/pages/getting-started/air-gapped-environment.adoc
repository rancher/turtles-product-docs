 ...
 ** Provide fetch configuration and image values for `core` and `caprke2` providers in link:../reference-guides/rancher-turtles-chart/values.adoc#cluster-api-operator-values[values.yaml].
