...
** xref:user/fleet-integration.adoc[Fleet Integration]
** xref:user/rancher-cluster-registration.adoc[Rancher Cluster Registration]
** xref:user/applications.adoc[Installing applications]
** xref:user/caapf.adoc[CAPI Addon Provider Fleet (deprecated)]
