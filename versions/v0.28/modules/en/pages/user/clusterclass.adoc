= ClusterClass
:description: Learn how to use ClusterClass with the SUSE Rancher Prime Cluster API to set up clusters on Azure, AWS, GCP, or Docker
:revdate: 2026-08-11
...
[CAUTION]
====
In previous versions of {product_name}, CAAPF was installed by default. From Rancher 2.14.1 onwards, it is no longer part of {product_name} and if required it needs to be installed separately. For more information on how to do this, see the xref:user/caapf.adoc[CAAPF] section.
====
...
include::shared:ROOT:partial$en/cni-caution.adoc[]
...
+
We can do this automatically using a https://cluster-api.sigs.k8s.io/tasks/cluster-resource-set[ClusterResourceSet] to apply the https://docs.rke2.io/add-ons/helm[HelmChart] downstream.
+
...
data:
  cloud-provider-azure.yaml: |-
    ...
    spec:
      ...
      bootstrap: true
      version: "{cloud_provider_azure_version}"
...
----
+
* Once the Cluster is initialized, you can install a CNI of your choice and the https://github.com/kubernetes-sigs/cloud-provider-azure[Azure Cloud Provider]. Refer to the upstream https://capz.sigs.k8s.io/[CAPZ documentation].
+
--
...
----
+
* Once the Cluster is initialized, you can install a CNI of your choice and the https://github.com/kubernetes/cloud-provider-gcp[GCP Cloud Provider]. Refer to the upstream https://cluster-api-gcp.sigs.k8s.io[CAPG documentation].
+
--
...
----
* Once the Cluster is initialized, you can install a CNI of your choice, the https://github.com/kubernetes/cloud-provider-vsphere[vSphere Cloud Provider], and the https://github.com/kubernetes-sigs/vsphere-csi-driver[Container Storage Interface (CSI) driver for vSphere].
--
...
We can do this automatically using a https://cluster-api.sigs.k8s.io/tasks/cluster-resource-set[ClusterResourceSet].
The CPI and CSI charts can also be installed using the same workflow by applying the https://docs.rke2.io/add-ons/helm[HelmChart] downstream.
+
