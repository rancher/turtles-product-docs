= Guidelines
:description: Learn how to contribute to Rancher CAPI extension projects by following these guidelines for submitting issues, pull requests, and improving documentation
:revdate: 2025-10-02
