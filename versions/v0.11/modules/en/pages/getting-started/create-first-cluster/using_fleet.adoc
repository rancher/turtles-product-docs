...
:description: Create and import your first cluster using Fleet by generating cluster definitions with clusterctl and configuring Rancher Manager to automatically import
:revdate: 2025-11-14
...
The *fleet.yaml* is used to specify configuration options for fleet (see https://documentation.suse.com/cloudnative/continuous-delivery/latest/en/reference/ref-fleet-yaml.html[Fleet reference documentation] for further details). In this instance its declaring that the cluster definitions should be added to the *default* namespace.
endif::[]
ifeval::["{build-type}" == "community"]
The *fleet.yaml* is used to specify configuration options for fleet (see https://fleet.rancher.io/ref-fleet-yaml[Fleet reference documentation] for further details). In this instance its declaring that the cluster definitions should be added to the *default* namespace.
endif::[]
====
