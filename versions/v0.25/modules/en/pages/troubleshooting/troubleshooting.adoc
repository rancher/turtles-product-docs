...
You can edit CAPIProvider resources for providers where increasing the log level is needed. Change to your desidered level as seen in the example below:
