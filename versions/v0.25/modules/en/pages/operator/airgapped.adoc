...
:description: Learn how SUSE Rancher Prime Cluster API supports air-gapped environments using CAPIProvider and CAPI Operator to manage Cluster API manifests
:revdate: 2026-06-26
...
You can mirror OCI artifacts for any CAPI Provider listed in the {product_name} configuration: https://github.com/rancher/turtles/blob/main/internal/controllers/clusterctl/config-community.yaml.
...
Install the https://cluster-api-operator.sigs.k8s.io/topics/plugin/installation[cluster-api-operator] plugin for `kubectl`.
