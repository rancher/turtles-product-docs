...
[IMPORTANT]
====
Starting with Rancher v2.13, {product_name} is installed by default as part of Rancher, and does not need to be installed manually. If you have been using earlier versions of {product_name}, make sure to follow the xref:tutorials/migration.adoc[migration guide] to facilitate a seamless upgrade process.
====
