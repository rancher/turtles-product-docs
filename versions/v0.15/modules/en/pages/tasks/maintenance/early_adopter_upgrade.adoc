...
:description: Upgrade to the GA version of SUSE® Rancher Prime Cluster API by deleting clusters, uninstalling Helm, cleaning resources, and installing the new version
:revdate: 2024-12-23
