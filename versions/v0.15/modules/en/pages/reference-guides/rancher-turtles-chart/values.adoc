= Chart configuration
:description: Configure feature flags for SUSE Rancher Prime Cluster API using Helm charts by setting values in the chart configuration, which allows customizing cluster settings
:revdate: 2024-12-23
