...
:description: Create your first cluster using Fleet by defining it with cluster API templates, setting up a Git repository, labeling the namespace for auto-import
:revdate: 2025-11-14
