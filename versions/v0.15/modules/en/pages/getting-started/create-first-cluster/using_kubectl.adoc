...
:description: Create your first cluster using kubectl by generating a YAML definition, applying it to your Rancher Manager cluster, and labeling the namespace or cluster
:revdate: 2024-12-23
