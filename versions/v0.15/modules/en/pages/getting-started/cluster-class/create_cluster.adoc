...
:description: Create a cluster using Fleet and ClusterClass with a GitOps workflow by importing cluster definitions and applying manifests through Rancher Manager
:revdate: 2024-12-23
