= Glossary
:description: Find definitions of Kubernetes and Cluster API terms including Add-ons, Bootstrap, Cluster, Control plane, Infrastructure provider, and provisioning
:revdate: 2026-05-12
