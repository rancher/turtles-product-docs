...
:description: Enabling ClusterClass requires setting CLUSTER_TOPOLOGY to true in the CAPI Provider configuration, which the Helm chart automatically sets
:revdate: 2025-03-31
