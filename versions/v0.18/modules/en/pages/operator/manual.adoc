= Manual Installation
:description: Install SUSE® Rancher Prime Cluster API manually using the Helm CLI by adding the rancher-turtles Helm repository and running helm install commands,
:revdate: 2025-09-15
