= Install
:description: Install SUSE® Rancher Prime Cluster API using Rancher Dashboard to add the Cluster API extension and transform your Rancher Manager cluster into a CAPI
:revdate: 2025-10-02
