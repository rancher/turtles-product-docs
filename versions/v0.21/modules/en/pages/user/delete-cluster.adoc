...
:description: Delete a Rancher cluster by using cluster-api.cattle.io labels to remove the clusters.management.cattle.io resource and prevent automatic re-import
:revdate: 2026-03-05
