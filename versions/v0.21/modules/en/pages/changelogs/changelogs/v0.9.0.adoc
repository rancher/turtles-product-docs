...
<h4>Starting with Turtles <code>v0.9.0</code>, the process used for importing CAPI clusters into Rancher has changed. We recommend you take a look at the changelog and the instructions provided in the <code>v0.9</code> version of the Turtles book: <a href="https://documentation.suse.com/cloudnative/cluster-api/latest/en/index.html/" rel="nofollow">https://documentation.suse.com/cloudnative/cluster-api/latest/en/index.html/</a></h4>
endif::[]
