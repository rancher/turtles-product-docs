= Via Helm install
:description: Install SUSE® Rancher Prime Cluster API via Helm by adding the required repository, ensuring Cluster API Operator is included as a dependency
:revdate: 2025-10-02
