...
:description: Configure Cluster API providers and the Cluster API Operator for an air-gapped environment by setting image overrides and fetching configuration from internal
:revdate: 2026-09-02
