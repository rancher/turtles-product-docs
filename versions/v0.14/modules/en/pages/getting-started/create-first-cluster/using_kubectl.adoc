...
:description: Create your first cluster using kubectl and import it into Rancher Manager by generating a YAML definition with the Docker infrastructure provider and applying it
:revdate: 2024-12-23
