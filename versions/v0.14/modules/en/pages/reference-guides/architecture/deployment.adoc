...
:description: Learn about a deployment scenario where Rancher Manager and CAPI Management are combined in a Kubernetes cluster for centralized management
:revdate: 2024-12-23
