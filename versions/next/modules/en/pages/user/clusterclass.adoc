...
. **Before** upgrading Rancher, update all the `HelmApps` with `HelmApp.spec.keepResources: true`. This will prevent the deployed Helm chart to be uninstalled downstream once the `HelmApp` resource is deleted.  
. Upgrade Rancher to `v2.12` or higher. Wait until the `HelmApp` CRD has been removed, and the new `HelmOp` has been installed by the Fleet `v0.13` version update.  
. Upgrade Rancher Turtles to `v0.24` or higher.  
. Deploy the converted `HelmOps` ensuring `HelmOp.spec.helm.takeOwnership: true`.
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r azure-rke2 | kubectl apply -f -
----
kubectl::
+
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/azure/rke2/clusterclass-rke2-example.yaml
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/ccm/azure/helm-chart.yaml
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/cni/calico/helm-chart.yaml
----
=======
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/azure/aks/clusterclass-aks-example.yaml
----
=======
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/azure/kubeadm/clusterclass-kubeadm-example.yaml
----
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r aws-kubeadm | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/aws/kubeadm/clusterclass-kubeadm-example.yaml
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/csi/aws/helm-chart.yaml
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/cni/aws/calico/helm-chart.yaml
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/ccm/aws/helm-chart.yaml
----
=======
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r aws-rke2 | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/aws/rke2/clusterclass-ec2-rke2-example.yaml
----
=======
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r gcp-kubeadm | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/gcp/kubeadm/clusterclass-kubeadm-example.yaml
----
+
* For this example we are also going to install https://docs.tigera.io/calico/latest/about/[Calico] as the default CNI.
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/ccm/gcp/bundle.yaml
----
=======
+
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r docker-kubeadm | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/docker/kubeadm/clusterclass-docker-kubeadm.yaml
----
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r docker-rke2 | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/docker/rke2/clusterclass-docker-rke2.yaml
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/lb/docker/configmap.yaml
----
=======
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r vsphere-kubeadm | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/vsphere/kubeadm/clusterclass-kubeadm-example.yaml
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/ccm/vsphere/helm-chart.yaml
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/cni/calico/helm-chart.yaml
----
+
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/applications/csi/vsphere/bundle.yaml
----
=======
...
[source,bash]
----
go run github.com/rancher/turtles/examples@v0.24.0 -r vsphere-rke2 | kubectl apply -f -
----
...
[source,bash]
----
kubectl apply -f https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.24.0/examples/clusterclasses/vsphere/rke2/clusterclass-rke2-example.yaml
----
