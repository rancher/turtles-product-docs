...
[NOTE]
====
Please feel free to skip <<_adrs_architectural_decision_records,this>> and <<process,sub-section>> below, since they are only relevant to the https://github.com/rancher/turtles[rancher-turtles] repository.
====
