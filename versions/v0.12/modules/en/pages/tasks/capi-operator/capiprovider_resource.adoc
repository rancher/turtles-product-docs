...
:description: Create a CAPIProvider resource to manage Cluster API Operator manifests declaratively by specifying provider name, type, credentials, and features
:revdate: 2026-06-26
