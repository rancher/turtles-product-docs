= Guidelines
:description: Find guidelines for contributing to the Rancher CAPI extension projects, including submitting patches, fixing bugs, improving documentation, and reviewing code
:revdate: 2025-10-02
