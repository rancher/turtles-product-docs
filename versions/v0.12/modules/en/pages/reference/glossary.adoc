= Glossary
:description: Define terms related to Kubernetes cluster management, deployment, and configuration, including add-ons, environments, providers, control planes
:revdate: 2026-05-12
