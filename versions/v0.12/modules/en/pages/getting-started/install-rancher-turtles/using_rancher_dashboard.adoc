...
:description: Install SUSE Rancher Prime Cluster API via Rancher Dashboard by adding the Turtles repository and using the Rancher UI to install the Cluster API Extension
:revdate: 2025-10-02
