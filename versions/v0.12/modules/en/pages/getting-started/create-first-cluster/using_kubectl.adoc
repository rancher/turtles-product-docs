...
:description: Create your first cluster using kubectl to generate a YAML definition, then import it into Rancher Manager and set auto-import labels for namespaces
:revdate: 2024-10-09
