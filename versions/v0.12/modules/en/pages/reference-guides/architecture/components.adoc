= Components
:description: Understand the key components of the SUSE® Rancher Prime Cluster API system and how Rancher Manager, Rancher Cluster Agent, and the CAPI extension work
:revdate: 2024-10-09
