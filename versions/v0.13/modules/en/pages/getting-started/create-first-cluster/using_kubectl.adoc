...
:description: Create and import your first cluster using kubectl commands to define and manage it in Rancher Manager by generating YAML files and applying labels
:revdate: 2024-10-29
