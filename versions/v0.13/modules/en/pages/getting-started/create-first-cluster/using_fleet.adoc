...
:description: Create your first cluster using Fleet by generating a cluster definition with YAML templates, setting up a Git repository, and labeling a namespace
:revdate: 2025-11-14
