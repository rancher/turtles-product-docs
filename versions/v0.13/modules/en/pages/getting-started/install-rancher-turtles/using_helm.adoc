= Via Helm install
:description: Install SUSE Rancher Prime Cluster API via Helm, with the Cluster API Operator as a dependency to manage Cluster API Providers and configure the required feature flags
:revdate: 2025-10-02
