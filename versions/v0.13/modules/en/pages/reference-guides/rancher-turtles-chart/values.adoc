= Chart configuration
:description: Configure chart settings for SUSE Rancher Prime Cluster API via the official Helm chart to set feature flags and pass values to the Cluster API Operator
:revdate: 2024-10-29
