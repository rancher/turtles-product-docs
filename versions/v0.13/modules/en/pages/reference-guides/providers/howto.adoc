...
:description: Create and import a CAPI cluster using certified providers by generating a YAML definition with clusterctl and configuring infrastructure and control plane
:revdate: 2025-05-02
