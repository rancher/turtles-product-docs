...
:description: Upgrade to the GA version of SUSE® Rancher Prime Cluster API by following these steps: delete clusters, uninstall components, clean up resources, and install.
:revdate: 2024-10-29
