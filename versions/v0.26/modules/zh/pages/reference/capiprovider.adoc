...
上游 CAPI 操作员 `CAPIProviderSpec` 资源提供的每个字段在 `CAPIProvider` 资源的规格中也可用。请随时参考上游配置 link:https://cluster-api-operator.sigs.k8s.io/topics/configuration/provider-spec-configuration[指南] 以获取高级场景。
