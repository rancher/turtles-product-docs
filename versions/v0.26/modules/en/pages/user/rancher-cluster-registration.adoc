...
:description: Register a CAPI cluster in Rancher using Turtles auto-import by applying the cluster-api.cattle.io/rancher-auto-import label to a namespace or cluster
