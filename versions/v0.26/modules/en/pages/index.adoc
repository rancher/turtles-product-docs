...
[CAUTION]
====
Cluster API Add-on Provider for Fleet (CAAPF) is no longer installed by default. If you have been using Fleet to deploy workloads to your downstream CAPI clusters, refer to the xref:user/caapf.adoc[CAAPF user guide] for more information.
====
