= Rancher Setup
:description: Install Rancher using Helm to set up the first cluster, which deploys the CAPI controller, CRDs, and allows managing providers through the CAPIProvider
