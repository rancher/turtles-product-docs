...
If you are upgrading from an earlier version of Rancher with {product_name} already installed, refer to the xref:tutorials/migration.adoc[Migration Guide] before upgrading.
====
