...
:description: Create and import your first cluster using GitOps with Fleet or kubectl to apply resources and then check the Rancher Manager dashboard to confirm it's ready
