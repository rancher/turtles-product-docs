...
:description: Delete a Rancher-managed CAPI cluster using specific labels to mark it for removal, which removes the associated Rancher resource and prevents automatic
:revdate: 2026-03-05
