...
:description: Enable the managementv3-cluster-migration flag to prevent duplicate cluster imports and automatically re-import CAPI cluster definitions during upgrades
:revdate: 2025-02-10
