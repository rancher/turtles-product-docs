...
:description: Install SUSE® Rancher Prime Cluster API via Rancher Dashboard by adding the Turtles repository and letting Rancher handle the Cluster API Extension
:revdate: 2025-10-02
