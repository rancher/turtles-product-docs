...
:description: Deploy Rancher Manager and CAPI Management on a Kubernetes cluster to create a centralized management cluster with a single view of all clusters
:revdate: 2025-02-10
