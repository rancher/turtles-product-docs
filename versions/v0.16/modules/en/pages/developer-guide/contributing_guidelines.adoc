= Guidelines
:description: Find ways to contribute to Rancher CAPI extension projects by submitting patches, creating issues, submitting pull requests, and following guidelines
:revdate: 2025-10-02
